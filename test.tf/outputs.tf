...
output "additional_subnets" {
  description = "List of IDs of additional subnets"
  value       = aws_subnet.additional.*.id
}

output "additional_subnet_arns" {
  description = "List of ARNs of additional subnets"
  value       = aws_subnet.additional.*.arn
}

output "additional_subnets_cidr_blocks" {
  description = "List of cidr_blocks of additional subnets"
  value       = aws_subnet.additional.*.cidr_block
}

output "additional_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of additional subnets in an IPv6 enabled VPC"
  value       = aws_subnet.additional.*.ipv6_cidr_block
}
