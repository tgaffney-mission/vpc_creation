...
variable "additional_subnet_ipv6_prefixes" {
  description = "Assigns IPv6 addtional subnet id based on the Amazon provided /56 prefix base 10 integer (0-256). Must be of equal length to the corresponding IPv4 subnet list"
  type        = list
  default     = []
}
...
variable "additional_subnet_suffix" {
  description = "Suffix to append to additional subnets name"
  type        = string
  default     = ""
}
...
variable "additional_subnets" {
  description = "A map of additional subnets"
  default     = {}
}
...
variable "additional_subnet_tags" {
  description = "Additional tags for the addtional subnets"
  type        = map(string)
  default     = {}
}
